...
export default function AsambleasConjuntoPage({
  ...
  const enviarReportePorEmail = async (asambleaId: string) => {
    setEnviandoEmail(asambleaId)
    
    // TODO: Implementar envío de email en el siguiente paso
    setTimeout(() => {
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-6 text-sm text-slate-600">
                      ...
                      <div>
                        ...
                        <span className={`font-medium ${
                          asamblea.quorumInicial >= 50 ? 'text-green-600' : 'text-red-600'
                        }`}>
                      ...
                      {asamblea.quorumFinal !== null && (
                        <div>
                          ...
                          <span className={`font-medium ${
                            asamblea.quorumFinal >= 50 ? 'text-green-600' : 'text-orange-600'
                          }`}>
                  ...
                  {asamblea.estado === 'finalizada' && (
                    <div className="flex flex-col gap-2">
                      ...
                      <Button
                        onClick={() => enviarReportePorEmail(asamblea.id)}
                        size="sm"
                        variant="outline"
                        disabled={enviandoEmail === asamblea.id}
                      >
                        <Send className="mr-2 h-4 w-4" />
                        {enviandoEmail === asamblea.id ? 'Enviando...' : 'Enviar Email'}
                      </Button>
                    </div>
                  )}
